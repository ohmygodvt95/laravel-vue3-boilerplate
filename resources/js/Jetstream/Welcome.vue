<template>
  <div>
    <div class="tw-p-6 sm:tw-px-20 tw-bg-white tw-border-b tw-border-gray-200">
      <div>
        <jet-application-logo class="tw-block tw-h-12 tw-w-auto" />
      </div>

      <div class="tw-mt-8 tw-text-2xl">Welcome to your Jetstream application!</div>
    ...
    <div class="tw-bg-gray-200 tw-bg-opacity-25 tw-grid tw-grid-cols-1 md:tw-grid-cols-2">
      <div class="tw-p-6">
        <div class="tw-flex tw-items-center">
          ...
          <div class="tw-ml-4 tw-text-lg tw-text-gray-600 tw-leading-7 tw-font-semibold">
        ...
        <div class="tw-ml-12">
          ...
          <a href="https://laravel.com/docs">
            <div class="mt-3 tw-flex tw-items-center text-sm font-semibold text-indigo-700">
              <div>Explore the documentation</div>

              <div class="tw-ml-1 tw-text-indigo-500">
                <svg viewBox="0 0 20 20" fill="currentColor" class="tw-w-4 tw-h-4">
                  <path
                    fill-rule="evenodd"
      ...
      <div class="tw-p-6 tw-border-t tw-border-gray-200 md:tw-border-t-0 md:tw-border-l">
        <div class="tw-flex tw-items-center">
          <svg
            fill="none"
            stroke="currentColor"
      ...
      <div class="tw-p-6 tw-border-t tw-border-gray-200 md:border-l">
        <div class="tw-flex tw-items-center">
          <svg
            fill="none"
            stroke="currentColor"
