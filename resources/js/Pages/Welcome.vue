<template>
  ...
  <div
    class="
      tw-relative tw-flex tw-items-top tw-justify-center tw-min-h-screen tw-bg-gray-100
      dark:tw-bg-gray-900
  ...
  >
    ...
    <div class="tw-max-w-6xl tw-mx-auto tw-sm:px-6 tw-lg:px-8">
      <div class="tw-flex tw-justify-center tw-pt-8 tw-sm:justify-start tw-sm:pt-0">
        <svg
          viewBox="0 0 651 192"
          fill="none"
        ...
        <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2">
            ...
            <div class="tw-flex tw-items-center">
              ...
              <div class="tw-ml-4 tw-text-lg tw-leading-7 tw-font-semibold">
                <a
                  ...
                  class="tw-underline tw-text-gray-900 tw-dark:text-white"
                  >Laracasts</a
                >
              </div>
            </div>
          ...
          <div class="tw-p-6 tw-border-t tw-border-gray-200 dark:tw-border-gray-700 md:tw-border-l">
            <div class="tw-flex tw-items-center">
              ...
              <div
                class="
                  tw-ml-4 tw-text-lg tw-leading-7 tw-font-semibold
                  text-gray-900
                  dark:text-white
                "
              >
            ...
            <div class="tw-ml-12">
              <div class="tw-mt-2 tw-text-gray-600 dark:tw-text-gray-400 tw-text-sm">
                ...
                <a href="https://nova.laravel.com" class="tw-underline">Nova</a>, and
                <a href="https://envoyer.io" class="tw-underline">Envoyer</a> help you take your
                projects to the next level. Pair them with powerful open source libraries like
                <a href="https://laravel.com/docs/billing" class="tw-underline">Cashier</a>,
                <a href="https://laravel.com/docs/dusk" class="tw-underline">Dusk</a>,
                <a href="https://laravel.com/docs/broadcasting" class="tw-underline">Echo</a>,
                <a href="https://laravel.com/docs/horizon" class="tw-underline">Horizon</a>,
                <a href="https://laravel.com/docs/sanctum" class="tw-underline">Sanctum</a>,
                <a href="https://laravel.com/docs/telescope" class="tw-underline">Telescope</a>, and
                more.
              </div>
            </div>
          </div>
      ...
      <div class="tw-flex tw-justify-center tw-mt-4 sm:tw-items-center sm:tw-justify-between">
        <div class="tw-text-center tw-text-sm tw-text-gray-500 sm:tw-text-left">
          <div class="tw-flex tw-items-center">
            ...
            <a href="https://laravel.bigcartel.com" class="ml-1 tw-underline"> Shop </a>
